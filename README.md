...
* [AI Data Watch](https://baa-atlas.vercel.app/ai) - Per-AI-tool data-processing due diligence: does the tool train on your inputs, can you opt out, and does it offer zero-retention or a DPA (art. 28). Each verdict cites the vendor's own documentation with a last-verified date.
